...
__global__
void matTransposeWriteCoalescedKernel(float* A, float* B){
...
void matTransposeWriteCoalesced(float* A, float* B){
    float *A_d, *B_d;
    ...
    matTransposeWriteCoalescedKernel<<<dimGrid, dimBlock>>>(A_d, B_d);
...
int main(){
    ...
    matTransposeWriteCoalesced(A, B);
