...
__global__
void matTransposeReadCoalescedKernel(float* A, float* B){
...
void matTransposeReadCoalesced(float* A, float* B){
    float *A_d, *B_d;
    ...
    matTransposeReadCoalescedKernel<<<dimGrid, dimBlock>>>(A_d, B_d);
